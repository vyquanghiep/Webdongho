					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<form action="#" method="post">
								<input type="search" placeholder="Tìm theo thương hiệu..." name="search" required="">
							...
							<div class="left-side py-2">
								<ul>
									<li>
										...
										<span class="span">Klever Fruits</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">VinFruits</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">GreenSpace Store</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Minh Phương Fruits</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">DP Fruits</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">IFOOD</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
						...
						<div class="range border-bottom py-2">
							...
							<div class="w3l-range">
								<ul>
									<li>
										<a href="#">Dưới đ10,000</a>
									</li>
									<li class="my-1">
										<a href="#">đ10,000 - đ50,000</a>
									</li>
									<li>
										<a href="#">đ50,000 - đ100,000</a>
									</li>
									<li class="my-1">
										<a href="#">đ100,000 - đ200,000</a>
									</li>
									<li>
										<a href="#">đ200,000 - đ300,000</a>
									</li>
									<li class="mt-1">
										<a href="#">Trên đ300,000</a>
									</li>
								</ul>
							</div>
						</div>

...
<div class="dieu-huong">
	...
	<a href="danh-muc-san-pham.php?id=<?php echo $danhmuc ?>">  Danh mục sản phẩm >></a>
...
<div class="detail-product">
	...
	<div class="info-laptop">
		<div class="detail1">
			...
			Đường kính : <li><?php echo $chatlieuday ?></li><br>
			Chất liệu mặt kính: <li><?php echo $duongkinhmat ?></li><br>
			Chất liệu dây: <li><?php echo $nguondien ?></li><br>
			Chống nước:  <li><?php echo $doituong ?></li><br>
			Giá Tiền <li style="color: green; padding: 10px;font-size: 20px; font-weight: bold";><?php echo number_format($gia)." VNĐ" ?></li><br>
		</div>
		<div class="detail2">
			Nơi sản xuất <li><?php echo $chatlieumat ?></li><br>
			Trọng lượng <li><?php echo $trongluong ?></li><br>
			Chất liệu dây: <li><?php echo $hang ?></li><br>
			Năm Sản Xuất: <li><?php echo $namsx ?></li><br>
			Số Lượng Còn: <li><?php echo $soluong ?></li><br>
		</div>
	</div>
